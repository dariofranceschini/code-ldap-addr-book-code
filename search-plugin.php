...
<ShortName><? echo $site_name; ?></ShortName>
<Description>Search <? echo $site_name; ?></Description>
...
<Url type="text/html" method="GET" template="<? echo current_page_folder_url(); ?>?filter={searchTerms}"/>
