...
class openldap_back_hdb_schema extends ldap_schema
{
	function __construct(&$ldap_server)
	{
		...
		// Display layouts
		$ldap_server->add_display_layout("olcHdbConfig",array(
	...
	function populate_for_create_olcHdbConfig(&$ldap_server,&$entry)
	{
	...
	function before_create_olcHdbConfig(&$ldap_server,&$entry)
	{
		$ldap_server->ensure_openldap_module_loaded("back_hdb");

		$ldap_server->assign_ordered_sequence_rdn($entry,"olcDatabaseConfig","hdb",-1);
