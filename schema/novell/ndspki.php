...
class novell_ndspki_schema extends ldap_schema
{
	function __construct(&$ldap_server)
	{
		...
		$this->object_schema = array(
			array("name"=>"nDSPKIKeyMaterial",		"icon"=>"key-material.png",		"is_folder"=>false,"display_name"=>gettext("Key Material")),
		...
		$ldap_server->add_display_layout("nDSPKIKeyMaterial",array(
			array("section_name"=>gettext("Certificate Information"),
				"attributes"=>array(
					...
					array("ndspkiNotBefore",			gettext("Valid From"),				"date-time.png"),
					array("ndspkiNotAfter",				gettext("Valid To"),				"date-time.png"),
