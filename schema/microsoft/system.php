...
class microsoft_system_schema extends ldap_schema
{
	function __construct(&$ldap_server)
	{
		$this->attribute_schema = array(
			...
			array("name"=>"isGlobalCatalogReady",		"data_type"=>"yes_no",		"display_name"=>gettext("Is Global Catalog Ready")),
		...
		$ldap_server->add_display_layout("rootDSE",array(
			array("section_name"=>gettext("Active Directory Domain Controller"),"width"=>"50%",
				"attributes"=>array(
					...
					array("isGlobalCatalogReady",		gettext("Is Global Catalog Ready"),	"generic24.png","allow_edit"=>false),
